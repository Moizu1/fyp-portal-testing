...
const DashboardLayout = ({ children, role }) => {
  ...
  // Role-based navigation items with SVG icons
  ...
  return (
    <div className="flex h-screen bg-linear-to-br from-gray-50 to-gray-100">
      ...
      <aside
        ...
        } bg-linear-to-br from-slate-900 via-slate-800 to-slate-900 text-white transition-all duration-300 flex flex-col shadow-2xl`}
      >
        <div className="p-6 flex items-center justify-between border-b border-slate-700/50">
          <div className={`flex items-center space-x-3 ${!sidebarOpen && 'hidden'}`}>
            <div className="w-10 h-10 bg-linear-to-br from-purple-500 to-blue-500 rounded-lg flex items-center justify-center shadow-lg">
              <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
              </svg>
            </div>
            <h2 className="font-bold text-xl bg-linear-to-br from-purple-400 to-blue-400 bg-clip-text text-transparent">FYP Portal</h2>
          </div>
          <button
            onClick={() => setSidebarOpen(!sidebarOpen)}
            className="text-gray-400 hover:text-white hover:bg-slate-700 p-2.5 rounded-lg transition-all duration-200"
          >
        ...
        <div className="p-4 border-t border-slate-700/50">
          <button
            ...
            className="w-full flex items-center space-x-3 px-4 py-3.5 rounded-xl text-gray-300 hover:bg-red-600/90 hover:text-white transition-all duration-200 group"
          >
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="bg-white/80 backdrop-blur-sm shadow-sm border-b border-gray-200">
          <div className="px-8 py-5 flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <div className="bg-linear-to-br from-purple-100 to-blue-100 text-purple-800 px-5 py-2.5 rounded-full text-sm font-semibold shadow-sm border border-purple-200">
        ...
        {/* Body */}
        <main className="flex-1 overflow-y-auto p-8 bg-linear-to-br from-gray-50 to-gray-100">
          {children}
        </main>
      </div>
    </div>
